...
namespace YCYR.Views
{
    ...
    public partial class EaseMeasurementsPage : ContentPage
    {
        private EaseMeasurements measurements;
        public EaseMeasurementsPage(EaseMeasurements measurements)
        {
            InitializeComponent();
            ...
            ecCircTempleToTempleEase.Init();
            ecShoulderToShoulderOverHeadEase.Init();
            ecNeckCircumferenceEase.Init();
            ecChestCirEasec.Init();
            ecShoulderCircEase.Init();
            ecBicepCircEase.Init();
            ecForeArmCircEase.Init();
            ecWristCircEase.Init();
        ...
        {
            EaseMeasurements m = new EaseMeasurements();
            m.LoadSmallEaseDefaults();
            measurements.Copy(m);
